<template>
    <div class="shadow-lg">
        ...
        <p class="text-center text-black text-2xl break-words">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
            Perspiciatis nisi, provident ipsa ducimus aliquam quae.</p>
